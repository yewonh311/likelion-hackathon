...
<br/>first page to login / check-in main page <br/>
...
<br/>Google login using firebase implementation <br/>
...
<br/>Set pick-up location and destination with nickname <br/>
...
<br/>check-out page / Upload photo for reviews<br/>
